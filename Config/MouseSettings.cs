...
internal class MouseSettings : ModSettingsCategory
{
   ...
   public MouseSettings(string filePath, LanguageConfig lng) 
      : base("Mouse", filePath, lng)
   {
      _sensitivityHorizontal = CreateEntry("HorizontalSensitivity", 0.8f,
         "Mouse sensitivity for horizontal movement, increase if mouse moves too slow, decrease if too fast");
      _sensitivityVertical = CreateEntry("VerticalSensitivity", 0.8f,
